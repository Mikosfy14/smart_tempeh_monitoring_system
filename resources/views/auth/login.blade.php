...
@section('title', 'Login — Rizhomatix')
...
<div class="flex items-center justify-center min-h-screen">
    <div class="card-static w-full max-w-md animate-fade-in-up">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold">Rizhomatix</h1>
        ...
        <form method="POST" action="{{ route('login') }}" id="login-form">
            ...
            <div class="mb-6">
                <div class="flex items-center justify-between mb-1">
                    ...
                    <a href="{{ route('password.request') }}" class="text-xs font-medium hover:underline" style="color: var(--color-accent-teal);">Lupa Password?</a>
                </div>
                <div class="form-input-icon-wrapper">
                    <svg class="form-input-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
