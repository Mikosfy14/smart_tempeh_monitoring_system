...
<head>
    ...
    <title>@yield('title', 'Admin — Rizhomatix')</title>
    <meta name="description" content="@yield('description', 'Admin panel for Rizhomatix')">
...
<body class="min-h-screen">
    ...
    <aside class="sidebar" id="admin-sidebar">
        ...
        <nav class="flex-1 py-4">
            ...
            <a href="{{ route('admin.batches') }}" class="sidebar-link {{ request()->routeIs('admin.batches') ? 'active' : '' }}" id="nav-batches">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
