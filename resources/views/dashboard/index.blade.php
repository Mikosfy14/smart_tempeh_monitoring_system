...
<div class="stagger-children">
    ...
    <div class="card-static text-center py-20">
        ...
        <h2 class="text-2xl font-bold mb-3">Belum ada Device yang terdaftar</h2>
        <p class="text-sm mb-10 mx-auto" style="color: var(--color-text-secondary); max-width: 400px;">
            Daftarkan device pertama Anda dengan memasukkan Device ID yang tercetak pada perangkat ESP32.
        </p>
